...
# Don't look at this nightmare of a code to get the replicates into rowdata

treatlist = c("IM","IM_Galloflavin","IM_IL6", "IM_PD","IM_NoCT", "IM_NoINS",
              "IM_MK8722","IM_NoGluc","IM_UK5099","IM_Ipasertib","IM_Glut",
              "IM_EGF","IM_Rapamycin","Full_GM","IM_Oligomycin","IM_NoHC")

seurat@meta.data <-
  seurat@meta.data %>%
  mutate(replicate =
           ifelse(replicate_name %in% treatlist, 1, 2))
...
write_rds(seurat_sct, "./data_output/seurat_mfiltered_scaled_reg.rds")
